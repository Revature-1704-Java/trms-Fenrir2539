...
INSERT INTO EVENT
(EVENTID, EVENT_TYPE, REIM_PERCENT)
VALUES
...
(EVENTID, EVENT_TYPE, REIM_PERCENT)
VALUES
(3, 'Certificate Preparation Class', 75);
...
(REIMID, EMPLOYEEID, EVENTDATE, EVENTID, GRADEID, PASSINGGRADE, EMPLOYEE_COST, REIM_AMOUNT, REIM_LOCATION, REIM_DESCRIPTION, WORK_HOURS_MISSED, STATUS)
VALUES
(1, 1, TO_DATE ('9-FEB-2018'), 4, 2, '80', 400, 400, '1 Oracle Way', 'Java OCA 8 certification', 0, 'submitted');

INSERT INTO REIM_DATES
(REIMID, DATE_CREATE, CREATED_TIME, LAST_UPDATE_DATE)
VALUES
(2, null, null, null);
